...
pwd
${CC} -c ../src/dummy/libdummy/libdummy.c -o ./build/libdummy.o -Wall -fPIC -fpatchable-function-entry=${NOP_LENGTH}
# weak is built just to show that modified binutils support weak symbols
${CC} -c ../src/dummy/libdummy/weak.c -o ./build/weak.o -Wall -fPIC -fpatchable-function-entry=${NOP_LENGTH}
...
${CC} -c ../src/dummy/ex_1/ex1.c -o ./build/ex1.o
${CC} -c ../src/dummy/ex_2/ex2.c -o ./build/ex2.o
${CC} -c ../src/dummy/ex_3/ex3.c -o ./build/ex3.o
